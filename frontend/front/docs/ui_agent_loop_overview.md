...
- `front/app/page.tsx`
- `front/components/home/PageRightRail.tsx`
- `front/components/home/config.ts`
- `front/components/home/ExchangeLibraryModal.tsx`
- `front/components/home/StrategyLibraryWorkspace.tsx`
- `front/components/home/PortfolioWorkspace.tsx`
...
`front/lib/easyViewAgent.ts`는 이름에는 agent가 들어가지만, 현재 역할은 서버 AI를 다시 호출하는 것이 아니라 strategy graph를 UI 모델로 materialize하는 변환/하네스 레이어입니다.
...
- `front/lib/easyViewAgent.ts`
- `front/components/node-editor/types.ts`
...
핵심 컴포넌트는 `front/components/strategy-builder/EasyStrategyGraph.tsx`입니다.
...
- `front/components/strategy-builder/EasyStrategyGraph.tsx`
- `front/lib/easyViewAgent.ts`
- `front/app/page.tsx`
...
핵심 컴포넌트는 `front/components/node-editor/NodeEditor.tsx`입니다.
...
- `front/components/node-editor/NodeEditor.tsx`
- `front/components/node-editor/layout.ts`
- `front/components/node-editor/CustomEdge.tsx`
- `front/components/node-editor/StreamingNode.tsx`
- `front/components/node-editor/FunctionNode.tsx`
- `front/components/node-editor/MonitoringNode.tsx`
- `front/components/node-editor/CodeEditorNode.tsx`
- `front/components/node-editor/types.ts`
...
- `front/components/node-editor/StreamingNode.tsx`
- `front/components/node-editor/MetricChart.tsx`
- `front/components/node-editor/FunctionNode.tsx`
- `front/components/node-editor/types.ts`
- `front/server.mjs`
...
front/
  ...
  components/home/             홈 화면 nav, rail, 거래소 모달, 라이브러리/포트폴리오 UI
  components/strategy-builder/  쉬운 보기 그래프
  components/node-editor/       React Flow 기반 고급 보기 그래프 에디터
  components/ui/                shadcn/Radix 기반 공용 UI
  lib/                          프론트 상태 저장소와 그래프 변환/하네스
  ...
  src/                          이전 UI 계열과 현재도 재사용되는 일부 lib
...
- `front/src/App.jsx` 계열은 이전 UI지만, `front/src/lib/*` 일부는 현재 앱과 서버에서 재사용합니다.
