    ...
    <div className="preauth-content">
      ...
      <div className="preauth-list">
        {AUTH_PROVIDER_IDS.map((providerId) => {
          ...
          return (
            <Card as="section" key={providerId} className={`preauth-card${isReady ? ' verified' : ''}`}>
              <CardHeader className="preauth-card-head">
                <div>
              ...
              <CardContent className="preauth-card-content">
