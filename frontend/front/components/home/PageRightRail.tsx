...
import { BarChart3, Bot, ChevronLeft, ChevronRight, ExternalLink, FileCode2, ListChecks } from "lucide-react";
...
export function PageRightRail({
  ...
  return (
    <aside className="hidden min-h-0 w-full flex-col gap-2 overflow-y-auto border-l border-slate-200 bg-white p-2 xl:flex dark:border-slate-800 dark:bg-slate-950">
      ...
      <button className="mt-auto inline-flex h-9 items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white text-xs font-bold text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800">
